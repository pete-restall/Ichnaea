...
{
	[AggregateRoot]
	public class TwoHeterogenousEvents
	{
		...
		public void DoSomething(Guid firstToken)
		{
			...
			Source.Event.Of(new ObjectInitialiserSomethingHappened { Token = firstToken });
		}
		...
		[SuppressMessage("ReSharper", "EventNeverSubscribedTo.Global", Justification = CodeAnalysisJustification.IchnaeaSubscribes)]
		public event Source.Of<ObjectInitialiserSomethingHappened> SecondEventSource;
	}
}
